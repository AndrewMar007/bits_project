...
class VinylAudioTileWidget extends StatefulWidget {
  ...
  @override
  State<VinylAudioTileWidget> createState() => _VinylAudioTileWidgetState();
}

class _VinylAudioTileWidgetState extends State<VinylAudioTileWidget>
              ...
              SizedBox(
                ...
                child: Stack(
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(
                        left: size.height * 0.01 * widgetScalling,
                        top: size.height * 0.14 * widgetScalling,
                      ),
                      child: Text(
                        widget.author!,
